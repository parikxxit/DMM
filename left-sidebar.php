	...
	<header id="fh5co-header" role="banner">
		<nav class="navbar navbar-default" role="navigation">
			<div class="container-fluid">
				...
				<a class="navbar-brand" href="index.php">Booster</a>
				</div>
				<div id="fh5co-navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="index.php"><span>Home <span class="border"></span></span></a></li>
						<li><a href="right-sidebar.php"><span>Right Sidebar <span class="border"></span></span></a></li>
						<li class="active"><a href="left-sidebar.php"><span>Left Sidebar <span class="border"></span></span></a></li>
